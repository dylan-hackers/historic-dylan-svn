...
unless (e == #"copy")
  ...
  if (cr)
    ...
    if (member?(env, list("initialize (<subjunctive-"), //"replace-elements! (<vector>, <function>"), //"invert-accumulator", "ash"), //compute-slot-descriptors"), //"make-symbol (<sequence>"), //"as-field-size-for-tagged-integer"), //"compute-entry-count"),
