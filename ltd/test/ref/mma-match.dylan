      ...
      elseif (not(instance?(e, <list>)))
        ...
        begin
          ...
          elseif (isorderless)
            ...
            mlistol(tail(p), tail(e), 0, size(e) - 1, condition);
          else
            //  Flat or not, ordered.
