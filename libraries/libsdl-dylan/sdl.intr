...
define interface
 	 #include { "SDL/SDL.h", "SDL/SDL_active.h", "SDL/SDL_audio.h", "SDL/SDL_byteorder.h", "SDL/SDL_cdrom.h", "SDL/SDL_copying.h",
					...
					"SDL/SDL_types.h", "SDL/SDL_version.h", "SDL/SDL_video.h"				
					/*, "SDL/begin_code.h", "SDL/close_code.h"*/ },
					
    	name-mapper: c-ffi,
		import: all,  
		exclude: { "SDL_Error", // Fails to resolve at link time
			"SDL_dummy_enum", "main", "SDL_main", "SDL_RWFromFP" },
