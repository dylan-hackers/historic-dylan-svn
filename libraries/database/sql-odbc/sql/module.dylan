Module: dylan-user
Author: Dustin Voss
Synopsis: Module declaration for Gwydion Dylan version of Open Dylan's sql
          library. The sql module is used outside this file and exported as
          part of the sql-odbc module.
...
define module sql
  ...
  create
    ...
    close-dbms;
        // GF: close-dbms dbms => ()
        //       dbms  An instance of <dbms>.
        // Closes a DBMS and its connections.
...
define module result-set-implementation
  use dylan;              // common-dylan lib
  use common-extensions,  // common-dylan lib
    exclude: { format-to-string };
  use melange-support;    // odbc-ffi lib
