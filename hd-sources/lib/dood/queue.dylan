...
define method dood-queue-empty? (x :: <dood-queue>) => (well? :: <boolean>)
...
define method dood-queue-out (x :: <dood-queue>) => (res :: <integer>)
  queue-out(x)
end method;

define method dood-queue-out-setter (i :: <integer>, x :: <dood-queue>)
  queue-out(x) := i;
end method;

define method dood-queue-in (x :: <dood-queue>) => (res :: <integer>)
  queue-in(x)
end method;

define method dood-queue-in-setter (i :: <integer>, x :: <dood-queue>)
  queue-in(x) := i;
end method;
