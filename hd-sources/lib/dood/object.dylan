...
Version:      $HopeName: D-lib-dood!object.dylan(D-kan.16) $
...
define function dood-read-object-of-at
  ...
  if (*watchpoint-class* & debug-name(class) = *watchpoint-class*)
...
define constant $address-not-found = list("ADDRESS NOT FOUND");
